...
<p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/croct-tech/project-ts/releases">Releases</a>
    ·
    <a href="https://github.com/croct-tech/project-ts/issues">Report Bug</a>
    ·
    <a href="https://github.com/croct-tech/project-ts/issues">Request Feature</a>
</p>
...
1. Customize the repository
   ...
   4. Delete the `images` repository
